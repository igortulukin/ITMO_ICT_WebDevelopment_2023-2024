    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('arrive', 'Arrive'), ('departure', 'Departure')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('seat', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='main_app.seat')),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
